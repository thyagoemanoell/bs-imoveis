    ...
    <footer id="rodape">
          ...
          <div className="footer-contato-info">
            ...
            <div className="contato-detalhes">
              ...
              <div className="contato-det-item footer-det-item">
                ...
                {/* EDITAR: telefone do corretor */}
                <span>(11) 99999-9999</span>
              </div>
              <div className="contato-det-item footer-det-item">
                <WaIcon />
                {/* EDITAR: número WhatsApp */}
                <a href="https://wa.me/5511999999999" target="_blank" rel="noreferrer">(11) 99999-9999 (WhatsApp)</a>
              </div>
            </div>
          </div>
      ...
      <div className="footer-barra">
        <div className="footer-logo">
          ...
          <div>
            {/* EDITAR: nome e cargo no footer */}
            <div className="footer-logo-name">MARCOS OLIVEIRA</div>
            <div className="footer-logo-cargo">Corretor de Imóveis</div>
          </div>
        </div>

        {/* EDITAR: ano e nome no copyright */}
        <div className="footer-copy">© 2025 Marcos Oliveira. Todos os direitos reservados.</div>
