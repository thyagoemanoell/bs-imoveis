    ...
    <footer id="rodape">
          ...
          <div className="footer-contato-info">
            ...
            <div className="contato-detalhes">
              <div className="contato-det-item footer-det-item">
                ...
                <span>ayrton_bruno@hotmail.com</span>
              </div>
              <div className="contato-det-item footer-det-item">
                <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.8">
      ...
      <div className="footer-barra">
        ...
        <div className="footer-social-wrap">
          ...
          <a className="soc-ico" href="https://www.instagram.com/corretorbrunosena?igsh=dDhnYTFmMHhqd2hv" target="_blank" rel="noreferrer" aria-label="Instagram">
          ...
          <a className="soc-ico" href="https://www.facebook.com/brunosenaimoveis" target="_blank" rel="noreferrer" aria-label="Facebook">
            <svg fill="currentColor" viewBox="0 0 24 24">
